    ...
    const steps = [
      ...
      function showStep(step){
        switch(step){
            ...
            case 2:
                return <BankInfo handleNext={handleNext} handleBack={handleBack}/>
            case 3:
                return <SalaryInfo handleNext={handleNext} handleBack={handleBack} />   
            case 4: 
                return <PositionalInformation handleNext={handleNext} handleBack={handleBack}/>  
            case 5:
                return <Benefit handleNext={handleNext} handleBack={handleBack}/>     
            case 6:
                 return <BiographicInfo handleNext={handleNext} handleBack={handleBack}/>   
            case 7:
                 return <AdditionalAddress handleNext={handleNext} handleBack={handleBack}/>   
            case 8:
                return <EmergencyContact handleNext={handleNext} handleBack={handleBack}/> 
            case 9:
